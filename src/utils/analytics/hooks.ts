...
export const useAnalytics = () => {
  ...
  return {
    trackPluginClick: useCallback(
      (pluginId: string, pluginName: string, source?: string) => {
        analytics.trackPluginClick(pluginId, pluginName, source);
      },
      [analytics]
    ),

    trackMarketplaceClick: useCallback(
      (marketplaceId: string, marketplaceName: string, source?: string) => {
    ...
    trackDownload: useCallback(
      (itemId: string, itemType: 'plugin' | 'marketplace', itemName: string) => {
        analytics.trackDownload(itemId, itemType, itemName);
      },
      [analytics]
    ),

    trackRating: useCallback(
      (itemId: string, itemType: 'plugin' | 'marketplace', rating: number) => {
    ...
    trackShare: useCallback(
      (itemId: string, itemType: 'plugin' | 'marketplace', platform?: string) => {
    ...
    getTopMarketplaces: useCallback(
      (limit?: number) => {
    ...
    getPopularSearches: useCallback(
      (limit?: number) => {
