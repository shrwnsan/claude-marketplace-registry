      ...
      <div className='container mx-auto px-4 max-w-7xl'>
        ...
        <header className='text-center mb-12'>
          ...
          <p className='text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto'>
            Explore ecosystem quality metrics, verification status, maintenance indicators, and
            community trust signals. This dashboard provides comprehensive insights into the health
            and reliability of the plugin ecosystem.
          </p>
        </header>
        ...
        <section className='mb-12'>
          <div className='mb-6'>
            ...
            <p className='text-gray-600 dark:text-gray-400'>
              Core quality metrics with verification status, maintenance indicators, and trust
              signals.
            </p>
          </div>
        ...
        <section className='mb-12'>
          <div className='mb-6'>
            ...
            <p className='text-gray-600 dark:text-gray-400'>
              Comprehensive quality analysis including common issues, score distribution, and
              security overview.
            </p>
          </div>
        ...
        <section className='mb-12'>
          <div className='mb-6'>
            ...
            <p className='text-gray-600 dark:text-gray-400'>
              The QualityIndicators component includes numerous features for comprehensive quality
              monitoring.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            ...
            <div className='bg-white dark:bg-gray-800 rounded-lg shadow-md p-6'>
              ...
              <p className='text-gray-600 dark:text-gray-400'>
                Real-time verification rates and badge tracking for plugin security, quality,
            ...
            <div className='bg-white dark:bg-gray-800 rounded-lg shadow-md p-6'>
              ...
              <p className='text-gray-600 dark:text-gray-400'>
                Track plugin update frequencies, recently maintained projects, and identify
                abandoned plugins.
              </p>
            </div>
            ...
            <div className='bg-white dark:bg-gray-800 rounded-lg shadow-md p-6'>
              ...
              <p className='text-gray-600 dark:text-gray-400'>
                Comprehensive quality metrics with score distributions and common issue
                identification.
              </p>
            </div>
            ...
            <div className='bg-white dark:bg-gray-800 rounded-lg shadow-md p-6'>
              ...
              <p className='text-gray-600 dark:text-gray-400'>
                Security scan coverage, critical issue tracking, and overall ecosystem security
                scoring.
              </p>
            </div>
        ...
        <section className='mb-12'>
          <div className='mb-6'>
            ...
            <p className='text-gray-600 dark:text-gray-400'>
              Learn how to integrate and customize the QualityIndicators component in your
              application.
            </p>
          </div>
  ...
  return (
    ...
    />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              ...
              <div className='bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4'>
                <h4 className='font-medium text-gray-900 dark:text-gray-100 mb-2'>autoRefresh</h4>
                <p className='text-sm text-gray-600 dark:text-gray-400'>
              ...
              <div className='bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4'>
                <h4 className='font-medium text-gray-900 dark:text-gray-100 mb-2'>showDetailed</h4>
                <p className='text-sm text-gray-600 dark:text-gray-400'>
              ...
              <div className='bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4'>
                <h4 className='font-medium text-gray-900 dark:text-gray-100 mb-2'>compact</h4>
                <p className='text-sm text-gray-600 dark:text-gray-400'>
        ...
        <footer className='text-center py-8 border-t border-gray-200 dark:border-gray-700'>
          <p className='text-gray-600 dark:text-gray-400'>
            This demo showcases the QualityIndicators component from the Claude Code Marketplace
            ecosystem. The component provides comprehensive quality monitoring and insights for
            plugin ecosystems.
          </p>
        </footer>
      </div>
