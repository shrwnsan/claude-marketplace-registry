        ...
        return (
          ...
          >
            ...
            <div className='flex-1 text-left min-w-0'>
              ...
              <p className='text-xs text-gray-500 dark:text-gray-400'>{category.count} plugins</p>
            </div>
            {category.trending && (
    ...
    return (
      <div className={`card p-8 ${className}`}>
        <div className='text-center py-12'>
          ...
          <p className='text-lg text-gray-600 dark:text-gray-400'>No category data available</p>
        </div>
      </div>
    );
  }
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center space-x-3'>
          ...
          {selectedCategories.length > 0 && (
            <button onClick={clearFilters} className='btn-ghost p-2' aria-label='Clear all filters'>
              <X className='w-5 h-5' />
            </button>
          )}
        </div>
      ...
      {selectedCategories.length > 0 && (
        <div className='flex items-center space-x-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
          ...
          <span className='text-sm text-blue-800 dark:text-blue-200'>
            Filtering by {selectedCategories.length}{' '}
            ...
            >
              <div className='flex items-start space-x-3'>
                ...
                <div className='flex-1 min-w-0'>
                  <p className='font-medium text-gray-900 dark:text-gray-100'>{insight.category}</p>
