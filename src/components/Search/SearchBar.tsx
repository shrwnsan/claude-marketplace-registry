  ...
  return (
    <div className={`w-full max-w-4xl mx-auto ${className}`} ref={searchRef}>
      <form onSubmit={handleSubmit} className="relative">
        <div className="relative group">
          ...
          <div className="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
            <Search className="h-5 w-5 text-gray-400 dark:text-gray-500 group-focus-within:text-primary-500 transition-colors" aria-hidden="true" />
          </div>
      ...
      <div className="mt-4 sm:mt-6 flex flex-wrap gap-2 justify-center">
        <span className="text-sm text-gray-600 dark:text-gray-400 font-medium self-center">Trending:</span>
