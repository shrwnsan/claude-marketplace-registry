      ...
      {commits.length > 0 && (
        <div className="card">
          ...
          <div className="space-y-3">
            {commits.map((commit) => (
              <div key={commit.sha} className="flex items-start space-x-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {contributors.slice(0, 8).map((contributor) => (
              <div key={contributor.id} className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <img
