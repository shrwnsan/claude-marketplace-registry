...
- **Ecosystem at a glance** — live totals from the latest scan. The full dashboard lives at **/stats** (linked under the hero stats and in the footer).
...
The **Ecosystem Statistics** page ([/stats](/stats), linked under the hero stats and in the footer) covers:
