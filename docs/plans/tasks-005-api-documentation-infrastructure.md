...
**Created**: 2025-10-23
**Status**: Deferred — API routes have been removed (incompatible with GitHub Pages static site architecture). Would require a backend service or serverless functions.
**Assignee**: TBD