...
const AnalyticsDashboard: React.FC = () => {
  ...
  const pageViewStats = useMemo(() => getPageViewStats(timeRanges[timeRange]), [getPageViewStats, timeRange]);
  const eventCounts = useMemo(() => getEventCounts(timeRanges[timeRange]), [getEventCounts, timeRange]);
  ...
  const pageViewsChartData = useMemo(() => {
    return Object.entries(pageViewStats).map(([path, views]) => ({
