...
import { mockPlugins, mockMarketplaces, MarketplacePlugin } from 'src/data/mock-data';
...
const PluginDetailPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'installation' | 'usage' | 'security'>('overview');
  ...
  const pluginDetails = useMemo(() => {
    ...
    return {
      ...
      securityMetrics: {
        ...
        licenseCheck: plugin.license === 'MIT' || plugin.license === 'Apache-2.0' ? 'pass' : 'warning',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <nav className="mb-6">
              <ol className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <li className="flex items-center space-x-2">
                  <span>/</span>
                  <Link href="/plugins" className="hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                    Plugins
                  </Link>
                </li>
                <li className="flex items-center space-x-2">
            ...
            <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">Install command:</div>
                  ...
                  <div className="card">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {pluginDetails.agents.map((agent) => (
                        <div key={agent} className="flex items-center space-x-2 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div className="space-y-6">
                  ...
                  <div className="card">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        <span className="text-sm text-gray-600 dark:text-gray-400">Last Commit</span>
                        <span className="text-sm font-medium text-gray-900 dark:text-gray-100">
                        ...
                        <div className="relative">
                          <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm">
                            <div className="flex items-center justify-between">
                              ...
                              <button
                                onClick={() => copyToClipboard(getInstallCommand(), 'install-step1')}
                      ...
                      <div>
                        ...
                        <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <button
                              onClick={() => copyToClipboard('config.json content', 'install-step2')}
                      ...
                      <div>
                        ...
                        <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm">
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              onClick={() => copyToClipboard('claude plugins list', 'install-step3')}
                              className="text-gray-400 hover:text-white transition-colors"
                            >
                      ...
                      <div className="flex items-start space-x-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-blue-700 dark:text-blue-300">
                            This plugin is licensed under {plugin.license}, which is compatible with most projects.
                          </div>
                        </div>
                      </div>
                    </div>
