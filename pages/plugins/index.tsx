            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
              <div className='text-center mb-8'>
                ...
                <p className='text-lg text-gray-600 dark:text-gray-400 mb-8'>
                  Discover {filteredAndSortedPlugins.length} Claude Code plugins from {totalCount}{' '}
                  total across all marketplaces
                </p>
                ...
                <div className='flex items-center gap-4'>
                  <div className='flex items-center gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleSortChange(
                          e.target.value as 'stars' | 'downloads' | 'name' | 'updated'
                        )
                      }
                      ...
                      <div className='card flex items-center gap-4 p-6 hover:shadow-lg dark:hover:shadow-gray-900/30 transition-all duration-300'>
                        <div className='flex-1'>
                          <div className='flex items-center gap-3 mb-2'>
                            ...
                            <span className='badge badge-secondary text-xs'>{plugin.category}</span>
                          </div>
