...
import PluginCard from 'src/components/Marketplace/PluginCard';
import {
  Star,
  Github,
  ExternalLink,
...
import { MarketplacePlugin } from 'src/data/mock-data';
import { useRealMarketplaceData } from 'src/hooks/useRealMarketplaceData';
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={`${process.env.NEXT_PUBLIC_SITE_URL}/images/og-image.png`} />

        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={marketplace.name} />
        <meta name="twitter:description" content={marketplace.description} />
        <meta name="twitter:image" content={`${process.env.NEXT_PUBLIC_SITE_URL}/images/og-image.png`} />
      </Head>
            ...
            <nav className="mb-6">
              <ol className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <li className="flex items-center space-x-2">
                  <span>/</span>
                  <Link href="/marketplaces" className="hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                    Marketplaces
                  </Link>
                </li>
                <li className="flex items-center space-x-2">
                  <span>/</span>
                  <span className="text-gray-900 dark:text-gray-100 truncate">{marketplace.name}</span>
                </li>
              </ol>
            </nav>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <div className="card">
                ...
                <div className="space-y-3">
                  <p className="text-gray-600 dark:text-gray-300">
                    To use plugins from this marketplace, you need to add the marketplace URL to your Claude configuration:
                  </p>
              ...
              <div className="card">
                ...
                <div className="space-y-3">
                  <p className="text-gray-600 dark:text-gray-300">
                    Once configured, you can use plugins from this marketplace in your Claude Code sessions:
                  </p>
                  <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm">
                    <code>
                      # Install a plugin from the marketplace<br />
                      /install {marketplacePlugins[0]?.name.toLowerCase().replace(/\s+/g, '-') || 'plugin-name'}<br /><br />
                      # List available plugins<br />
                      /plugins<br /><br />
                      # Use a plugin<br />
                      /{marketplacePlugins[0]?.name.toLowerCase().replace(/\s+/g, '-') || 'plugin-name'} --help
                    </code>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {marketplaceData.marketplaces
                  ...
                  .map((relatedMarketplace) => (
                    <div key={relatedMarketplace.id} className="card group hover:shadow-lg transition-all">
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                        ...
                        >
                          View marketplace
                          <span className="ml-1 transform transition-transform group-hover:translate-x-1 inline-block">→</span>
                        </Link>
                      </div>
                    </div>
                  ))}
